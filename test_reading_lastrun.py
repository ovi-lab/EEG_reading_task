...
expName = 'test_reading'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\erang\\Desktop\\Reading_task\\test_reading_lastrun.py',
