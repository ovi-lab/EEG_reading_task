...
OVTK_StimulationId_ExperimentStart  = 1+0x8000  # 32769 
OVTK_StimulationId_ExperimentStop  = 2+0x8000  # 32770 

OVTK_StimulationId_Label_01 = 1+0x8100  # 33025 oddball
OVTK_StimulationId_Label_02 = 2+0x8100  # 33026 standard
